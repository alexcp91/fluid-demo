    ...
    <div className="flex min-h-[22rem] flex-1 flex-col bg-muted/60 p-5">
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-1.5 border-t border-border px-3 py-2">
          ...
          <Badge variant="dot" color="gray">
            {sizeModeLabel(chrome.widthMode, displayedWidth(chrome, state.source))}
          </Badge>
          {linked ? (
...
function ImagePanel({
  ...
  const chrome = activeChrome(state)
  const fileSource = state.source === "icon" ? "landscape" : state.source
              ...
              <InspectorSection title="Image" icon={ImageIcon}>
                <PropRow label="Source">
                  <SegmentGroup
                    ...
                    onChange={(sourceMode) => onPatch({ sourceMode })}
                ...
                {state.sourceMode === "icons" ? (
                  <FileMeta source="icon" />
                ) : null}
              </InspectorSection>
              <InspectorSection title="Content" icon={Type}>
                ...
                <PropRow label="Dynamic">
                  <SegmentGroup
                    ...
                    onChange={(value) =>
                      onPatch({ dynamicContent: value === "on" })
                    }
                    options={ON_OFF}
                  />
                </PropRow>
              ...
              <InspectorSection title="Spacing" icon={LayoutTemplate}>
                ...
                <PropRow label="Padding">
                  <QuadRow
                    ...
                    onToggleLink={() =>
                      onPatchChrome({
                        padding: toggleQuadLink(chrome.padding),
                      })
                    }
                  />
                </PropRow>
                <PropRow label="Margin">
                  <QuadRow
                    ...
                    onToggleLink={() =>
                      onPatchChrome({
                        margin: toggleQuadLink(chrome.margin),
                      })
                    }
                  />
                </PropRow>
